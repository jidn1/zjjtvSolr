...
function subLogin(){
     ...
     $('#loginForm').attr('action',$('#path').val()+"/user/Login.do").submit();
}
function refresh() {  
    var url = $("#basePath").val() + "/user/check.do?number="+Math.random();  
    $("#img").attr("src",url);  
}  
</script>
<body>
...
<div class="contain">
    <div class="myhead">
        ...
        <ul class="head-right">
            ...
            <li>|</li>
            <li><a href="<c:url value='/index.html'/>">请登录&nbsp;</a></li>
            <li>|</li>
            <li><a href="${pageContext.request.contextPath}/user/toRegister.do" class="red-a">免费注册</a></li>
            <li><a href="javascript:void(0);">Hi,欢迎来中检！&nbsp;</a></li>
        </ul>
    </div>
    <div class="mybanner">
        ...
        <div class="login">
            ...
            <form id="loginForm" method="post"   >
                ...
                <%--  <div class="login2">验证码    <img id="img" src="<%=basePath%>/user/check.html" onclick="refresh()" style="width: 120px;">   </div> --%>
