...
public interface PersonDao {
	 ...
	 * @throws Exception
	 */
	public userLoginPojo findUserLogin(Map<String, String> paramMap) throws Exception;
	/**
	 * 查询权限
	 * @param str
	 * @return
	 * @throws Exception
	 */
	public String getPermissionsByGroupIds(Map<String, Object> map) throws Exception;
	/**
	 *  修改用户logo
	 * @param l
	 */
