...
public class ListUtils {  
    ...
    private static <E> int compareObject(final String sortname, final boolean isAsc, E a, E b) throws Exception {  
        ...
        if(str1 == null || str2 == null){
			...
			return 0;
		}else if(str1.lastIndexOf(".") == str2.lastIndexOf(".")){
			ret = beforeValue(str1).compareTo(beforeValue(str2));
			if(ret == 0){
				//根据业务增加的方法
				int maxlen0 = Math.max(str1.length(), str2.length());
				int v1 = maxlen0 - str1.length();
				int v2 = maxlen0 - str2.length();
				if(v1 > 0){
					str1 = beforeValue(str1) + ListUtils.addZeroFrontStr(afterValue(str1), v1);
				}
				if(v2 > 0){
					str2 = beforeValue(str2) + ListUtils.addZeroFrontStr(afterValue(str2), v2);
				}
			}else {
				return ret;
			}
     ...
     * @return 
     */  
    public static String addZeroStr(Number numObj, int length) {  
    ...
    public static String addZeroFrontStr(String numObj, int length) {  
        for (int i = 0; i < length; i++) {
        	numObj = "0" + numObj;
		}  
        return numObj;  
    }  
    public static String addZeroAfterStr(String numObj, int length) {  
    	for (int i = 0; i < length; i++) {
    		numObj = numObj + "0";
    	}  
    	return numObj;  
    ...
    public static String beforeValue(String fileName){
    	try{
    ...
    public static String afterValue(String fileName){
		try{
